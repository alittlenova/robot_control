...
void I2C_GTP_EXTI_Config(FunctionalState Work)
{
  ...
  EXTI_InitStructure.EXTI_LineCmd = Work;
  EXTI_Init(&EXTI_InitStructure);  
}
void I2C_GTP_NVIC_Config(FunctionalState Work)
{
  ...
  NVIC_InitStructure.NVIC_IRQChannelCmd = Work;
...
{
	I2C_GTP_GPIO_Config();
  I2C_GTP_EXTI_Config(ENABLE);
	I2C_GTP_NVIC_Config(ENABLE);
}
...
{
	I2C_GTP_GPIO_Config();
  I2C_GTP_EXTI_Config(DISABLE);
	I2C_GTP_NVIC_Config(DISABLE);
}
